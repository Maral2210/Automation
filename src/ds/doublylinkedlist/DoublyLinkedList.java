...
public class DoublyLinkedList {
        ...
        private Node first;//first instance variable
        private Node last;// last instance variable

        public DoublyLinkedList() {//constructor
            this.first = null;//if instance variables are not initialized they will equal to null by default
            this.last = null;
        }
        ...
        public void insertFirst(int data) {
            ...
            newNode.next = first;//the node's next field will point to the first
            this.first = newNode;
        }
        ...
        public void insertLast(int data) {
            ...
            last = newNode;//the linked:ist last field should point to the new node
        }
        ...
        public Node deleteLast() {
            ...
            last = last.previous;//it's previous node to be the new last node
            return temp;
        }
        ...
        public void displayForward() {
            ...
            while (current != null) {
                ...
                current = current.next;//move tp the next mode
            }
            System.out.println();
        }
...
//this is our Doubly Linked list data structure
